...
(10, 4, 8, 11, '2026-02-04 21:00:00', 'completed', '', '2026-01-01 13:16:36'),
(15, 4, 8, 8, '2026-01-20 21:30:00', 'completed', 'daas', '2026-01-17 02:54:59'),
(16, 4, 12, 12, '2026-01-20 11:00:00', 'cancelled', 'asdsadadad', '2026-01-17 02:56:02'),
(17, 4, 12, 12, '2026-01-20 12:00:00', 'completed', 'help me!', '2026-01-17 02:57:47'),
(18, 4, 12, 12, '2026-01-28 08:30:00', 'completed', 'og', '2026-01-17 02:58:12'),
(19, 6, 12, 12, '2026-01-21 10:30:00', 'completed', 'fsdafsaf', '2026-01-17 02:58:59'),
(20, 6, 12, 12, '2026-01-20 10:00:00', 'cancelled', 'i can choose any time', '2026-01-17 02:59:32'),
(21, 6, 12, 12, '2026-01-19 11:30:00', 'confirmed', 'fdsf', '2026-01-17 03:05:03'),
...
(24, 4, 12, 12, '2026-01-24 09:00:00', 'completed', 'nice now the days are working', '2026-01-17 10:04:01'),
(25, 13, 12, 8, '2026-01-18 20:00:00', 'cancelled', 'am begging am begging youuuu', '2026-01-17 16:51:43'),
(27, 4, 8, 15, '2026-04-22 11:30:00', 'completed', 'dsfs', '2026-04-02 01:18:23'),
(28, 13, 8, 15, '2026-04-17 11:30:00', 'completed', 'vfdfdsgsd', '2026-04-02 01:24:51'),
(29, 13, 14, 14, '2026-04-16 09:00:00', 'completed', 'dsd', '2026-04-02 01:27:21'),
(30, 13, 8, 11, '2026-04-13 16:30:00', 'completed', 'fds', '2026-04-02 01:27:42'),
(31, 6, 8, 15, '2026-04-16 09:30:00', 'pending', 'dsadasds', '2026-04-02 15:47:24'),
(32, 6, 8, 15, '2026-04-16 09:30:00', 'pending', 'dsadasds', '2026-04-02 15:47:25');
...
INSERT INTO `reviews` (`id`, `booking_id`, `student_id`, `tutor_profile_id`, `rating`, `comment`, `created_at`) VALUES
(1, 17, 4, 12, 5, 'Excellent math tutor! Very patient and thorough.', '2026-01-20 14:00:00'),
(3, 10, 4, 11, 5, 'awesome', '2026-04-02 01:16:23'),
(4, 15, 4, 8, 4, 'nice', '2026-04-02 01:16:28'),
(6, 30, 13, 11, 5, 'fsfds', '2026-04-02 01:30:35'),
(7, 29, 13, 14, 5, 'fsddsafdsa', '2026-04-02 13:14:08'),
(11, 27, 4, 15, 5, 'lovely teacher\n ', '2026-04-02 22:58:31');
...
(15, 8, 'decimals', 24.50, 5, 'Mathematicis', '03:05', '23:03', 'Sat,Fri,Thu,Wed,Tue,Mon');
...
(16, 'hello@gmail.com', '$2y$12$uNaqFRpj2Tz6iK8IZ/w4KuKdj6N9FBbejIOg5cm8Kt.4qQcADKUTe', 'hello', 'mellow', 'student', '2026-04-02 11:23:18'),
(17, 'test99@test.com', '$2y$12$9Jlfk/nVkcViWssB5t./uuz/id58ZiVK90nBF0589xrZxtZ7/aE5G', 'Test', 'User', 'student', '2026-04-03 00:43:49');
...
ALTER TABLE `reviews`
  ...
  ADD KEY `student_id` (`student_id`),
  ADD KEY `tutor_profile_id` (`tutor_profile_id`);
...
ALTER TABLE `bookings`
  ...
  ADD CONSTRAINT `bookings_ibfk_3` FOREIGN KEY (`profile_id`) REFERENCES `tutor_profiles` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `reviews`
  ...
  ADD CONSTRAINT `reviews_ibfk_3` FOREIGN KEY (`tutor_profile_id`) REFERENCES `tutor_profiles` (`id`) ON DELETE CASCADE;
